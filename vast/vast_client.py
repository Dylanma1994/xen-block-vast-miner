# reference from: https://github.com/Barahlush/vastai_client
...
class VastClient:
    ...
    sys=None):
        ...
        r.raise_for_status()
        logger.info(f"rend {id} res {r.json()}")
    ...
    def set_api_key(self, new_api_key: str) -> None:
        ...
        """
        with open(self.api_key_file, 'w') as writer:
            writer.write(new_api_key)
        logger.info('Your api key has been saved in {}'.format(self.api_key_file))
