...
class BannerWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.appLabel = QLabel('Vast Miner', self)
...
class VastInterface(ScrollArea):
    ...
    def _init_widget(self):
        ...
        self.setObjectName('VastInterface')
        StyleSheet.VAST_INTERFACE.apply(self)
    ...
    def load_samples(self):
        ...
        self.vBoxLayout.addWidget(basic_input_view)
        basic_input_view.addSampleCard(f"{cfg.imagePath}/logo.png",
